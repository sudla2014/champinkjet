...
<div class="app-content content">
    <div class="content-wrapper">
        <div class="content-body">
          ...
          <i class="fas fa-image"></i> จัดการออกแบบงาน
              </div>
                <div class="card-body">
  ...
  SELECT * FROM orders INNER JOIN member ON member.Mem_Id=orders.Mem_Id
    ...
    INNER JOIN status ON status.St_Id=orders.St_Id INNER JOIN style ON style.S_Id=orders.S_Id where orders.St_Id IN (5,6,7,11,12)
  ";
                           ...
                           echo $Mem_Fname." ".$Mem_Lname;?></td>
                                ...
                                <td class="text-center align-middle">
                                  <div class="form-check form-check-inline">
                                    <?php if($St_Id1=='6'){
                                    echo "<a class=\"btn btn-success  btn-glow disabled\" tabindex=\"-1\" role=\"button\" aria-disabled=\"true\" href=\"artworkre.php?Or_Id=$Or_Id\">กำลังดำเนินการ</a>";
                                  }else {
                                  echo "<a class=\"btn btn-success  btn-glow\" href=\"artworkre.php?Or_Id=$Or_Id\">กำลังดำเนินการ</a>";
                                  }?>

                                    <a class="btn btn-info btn-glow" href="artworkprogress.php?Or_Id=<?php echo $Or_Id?>">ทำแบบเรียบร้อย</a>
                                      <a class="btn btn-primary btn-glow" href="artworkrecom.php?Or_Id=<?php echo $Or_Id?>">ดำเนินการผลิต</a>
                                      <?php if($St_Id1=='12'){
                                      echo "<a class=\"btn btn-warning  btn-glow disabled\" tabindex=\"-1\" role=\"button\" aria-disabled=\"true\" href=\"artworkwaiting.php?Or_Id=$Or_Id\">รอลูกค้าคอนเพิร์น</a>";
                                    }else {
                                    echo "<a class=\"btn btn-warning btn-glow\" href=\"artworkwaiting.php?Or_Id=$Or_Id\">รอลูกค้าคอนเพิร์น</a>";
                                    }?>
