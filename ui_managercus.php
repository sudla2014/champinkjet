    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <section id="date-dropper">
                ...
                <i class="fas fa-users"></i> จัดการข้อมูลลูกค้า</a>
                    </div>
                <div class="card-body">
                            ...
                            <form name="form1" method="get" action="">
                                <div class="form-row">
                                    <div class="form-group col-sm-4">
                                        <input type="text" class="form-control" name="keyword" placeholder="กรอกชื่อลูกค้า" id="keyword" value="<?=(isset($_GET['keyword']))?$_GET['keyword']:""?>">
                                    </div>
                                    ...
                                    <div class="form-group ml-auto">
                                        <a class="btn btn-outline-primary btn-glow" href="./registercus.php">เพิ่มข้อมูล</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-hover" style="width:100%">
                        ...
                        <tbody>
                            <?php
                  $num = 0;
                  $sql = "SELECT * FROM member WHERE member.Mem_Status='2' ";
                      ...
                      ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="./ui_managereditcus.php?Mem_Id=<?php echo $Mem_Id;?>" class="edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        <a href="./ui_managerdelcus.php?Mem_Id=<?php echo $Mem_Id;?>" class="delete" onClick="javascript:return confirm('คุณต้องการลบข้อมูลใช่หรือไม่');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
