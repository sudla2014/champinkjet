...
<div class="app-content content">
    ...
    <div class="text-center">
               ...
               echo "<a href=\"./ui_reportcount_pdf.php?date_start1=$date_start1&date_end1=$date_end1\" class=\"btn btn-outline-dark\">";
                    ...
                    <table class="table table-striped table-hover table-sm">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">จำนวนครั้งที่สั่ง</th>
                          </tr>
                        </thead>
  ...
  if(isset($_GET['Or_WorkDay']) && $_GET['Or_WorkDay']!=""  && isset($_GET['Or_WorkDay1']) && $_GET['Or_WorkDay1']!="")        //ถ้าตัวแปลไม่มีค่า ให้โชว์ข้อความ
  {
    $newDateStart1=$_GET['Or_WorkDay'];
    $newDateEnd1=$_GET['Or_WorkDay1'];
  $sql = "
  SELECT *,COUNT(orders.Mem_Id) as countcus FROM member LEFT JOIN orders ON orders.Mem_Id=member.Mem_Id  WHERE member.Mem_Status = 2
 And orders.Or_WorkDay BETWEEN '$newDateStart1' AND  '$newDateEnd1'   GROUP BY member.Mem_Id ";
    ...
    ?>
                              ...
                              <tr >
                                  ...
                                  <td class="text-center align-middle"><?php echo $Mem_Fname;?></td>
                                  <td class="text-center align-middle"><?php echo $Mem_Lname;?></td>
                                  <td class="text-center align-middle"><?php echo $Mem_Address;?></td>
                                  <td class="text-center align-middle"><?php echo $Mem_Phone;?></td>
                                  <td class="text-center align-middle"><?php echo $Mem_Email;?></td>
                                  <td class="text-center align-middle"><?php


                                     echo "<font color=\"Red\">$countcus</font>";
