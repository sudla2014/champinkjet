...
<div class="app-content content">
    ...
    <div class="text-center">
      ...
      $count_list_product_repair=0; //ตัวนับจำนวน list
       echo "<a href=\"./ui_reportstatus_pdf.php?date_start1=$date_start1&date_end1=$date_end1\" class=\"btn btn-outline-dark\">";
    ...
    <style>
                              ...
                              <tr id="<?php echo $Or_Qid;?>">
                                  ...
                                  <?php
                                    ...
                                    $Or_WorkDaynew = $str[2]."-".$str[1]."-".$str[0];
                                      echo "$Or_WorkDaynew";
                                  ?></td>
                                  <td class="text-center align-middle">
                                  <?php
                                    $str =   explode("-",$Or_ReceiveDay);
                                    $Or_ReceiveDaynew = $str[2]."-".$str[1]."-".$str[0];
                                      echo "$Or_ReceiveDaynew";
                                  ?></td>
