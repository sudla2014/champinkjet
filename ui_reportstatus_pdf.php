...
<tr>
  <td height="27" align="center"><strong><span class="style2"><font size="5">สรุปรายงานสถานะการสั่งงาน</font></span></strong></td>
</tr>
<tr>
...
<table width="100%" height="80%"  colspan="4" border="1" align="center"  cellpadding="0" cellspacing="0" class="table table-hover">
  <tr>
    ...
    <td align="center" bgcolor="#EAEAEA"><strong>ชื่อผลิตภัณฑ์</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>ชื่อลูกค้า</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>วันที่สั่งสินค้า</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>วันที่รับสินค้า</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>เวลาที่รับสินค้า</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>หมายเลขคิว</strong></td>
    <td align="center" bgcolor="#EAEAEA"><strong>สถานะ</strong></td>
   </tr>
     ...
     <div class="text-center">
       <tbody>
         <tr>
           ...
           <td align='center' width='10'><?php echo $Or_WorkDay; ?></td>
           <td align='center' width='10'><?php echo $Or_ReceiveDay; ?></td>
           <td align='center' width='8'><?php echo $Or_Time; ?></td>
           <td align='center' width='15'><?php echo $Or_Qnumber; ?></td>
					 <?php
	 				if($St_Id1=='4'){
	 						echo "<td align=\"center\" class=\"st4\" width=\"15\">$St_Name</td>";
	 					}elseif ($St_Id1=='3') {
	 						echo "<td align=\"center\" class=\"st3\" width=\"15\">$St_Name</td>";
	 					}elseif ($St_Id1=='2') {
	 						echo "<td align=\"center\" class=\"st2\" width=\"15\" >$St_Name</td>";
	 					}elseif ($St_Id1=='1') {
	 						echo "<td align=\"center\" class=\"st1\" width=\"15\" >$St_Name</td>";
	 					}else {
	 						echo "<td align=\"center\" class=\"st5\" width=\"15\"> $St_Name</td>";
	 					}?>
