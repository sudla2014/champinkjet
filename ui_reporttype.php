...
<div class="app-content content">
    ...
    <div class="text-center">
      ...
      $count_list_product_repair=0; //ตัวนับจำนวน list
       echo "<a href=\"./ui_reporttype_pdf.php?date_start1=$date_start1&date_end1=$date_end1\" class=\"btn btn-outline-dark\">";
                    ...
                    <table class="table table-striped table-hover table-sm">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">จำนวนคนนิยม</th>
                          </tr>
                        </thead>
  ...
  $sql = "
  SELECT *,COUNT(orders.Ty_Id) as counttype FROM `type` LEFT JOIN orders ON orders.Ty_Id=type.Ty_Id
  ...
  GROUP BY orders.Ty_Id ";
    ...
    <style>
                              ...
                              <tr>
                                  ...
                                  <td class="text-center align-middle"><?php echo $Ty_NameDetail;?></td>
                                  <td class="text-center align-middle"><?php echo $Ty_Price;?></td>
