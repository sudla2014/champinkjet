  ...
  role="navigation" data-menu="menu-wrapper">
    <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item" >
                <a class="dropdown nav-link btn-outline-purple " href=""><i class="fas fa-home"></i>
                    <span>หน้าแรก</span>
                </a>
            </li>
            <li class=" nav-item" >
                <a class="dropdown nav-link btn-outline-purple" href="about.php"><i class="fas fa-address-card"></i>
         ...
         <ul class="dropdown-menu">
           ...
           <li data-menu=""><a class="dropdown-item" href="" data-toggle="dropdown">รื้อถอน ติดตั้ง บริการอื่นๆ</a>
            ...
            <li class=" nav-item">
                <a class="dropdown nav-link btn-outline-purple " href="login.php" ><i class="fas fa-sign-in-alt"></i>
...
ไอเดียความคิดใหม่ ๆ เริ่มตั้งแต่การออกแบบดีไซน์ จนถึงงานผลิต เพื่อผลงานที่มีคุณภาพ สำหรับคุณ</p>
      ...
      <section id="timeline" class="timeline-center timeline-wrapper">
        <h3 class="page-title text-center">ข่าวสารและกิจกรรม</h3>
        <ul class="timeline">
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-card card border-grey border-lighten-2">
              <div class="card-header">
                <h4 class="card-title">มอบทุนการศึกษานักเรียน และทาสีอุปกรณ์สนามเด็กเล่น ณ<br>โรงเรียนธรรมญาณประยุต จ.สระแก้ว</h4>
                <p class="card-subtitle text-muted mb-0 pt-1">
                  <span class="font-small-3">13 ตุลาคม 2562</span>
                </p>
              ...
              <div class="card-content">
                <div  class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="assets/contact/IMG_0841.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/contact/IMG_0842.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/contact/IMG_0843.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/contact/IMG_0844.jpg" alt="First slide" width="100%">
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="#carousel-example-generic" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      ...
      <div class="timeline-card card border-grey border-lighten-2">
        <div class="card-header">
          <h4 class="card-title">อิงค์เจ็ท คืออะไร?</h4>
          <p class="card-subtitle text-muted mb-0 pt-1">
            <span class="font-small-3">13 ตุลาคม 2562</span>
          </p>
          <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
        ...
        <div class="embed-responsive embed-responsive-4by3">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/VFukgfhwcEk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
              </div>
              </div>
            </li>
